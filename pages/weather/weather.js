...
Page({
  data: {
    ...
    bcgImgList: [
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/beach-bird-birds-235787.jpg',
        topColor: '#393836'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/clouds-forest-idyllic-417102.jpg',
        topColor: '#0085e5'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/backlit-dawn-dusk-327466.jpg',
        topColor: '#2d2225'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/accomplishment-adventure-clear-sky-585825.jpg',
        topColor: '#004a89'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/fog-himalayas-landscape-38326.jpg',
        topColor: '#b8bab9'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/asphalt-blue-sky-clouds-490411.jpg',
        topColor: '#009ffe'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/aerial-climate-cold-296559.jpg',
        topColor: '#d6d1e6'
      },
      {
        src: 'cloud://wchat-3629g.7763-wchat-3629g-1302214208/wc/images/weather/beautiful-cold-dawn-547115.jpg',
        topColor: '#ffa5bc'
      }
    ],
    bcgImgIndex: 0,
  ...
  search (val, callback) {
    ...
    if (val) {
      ...
      this.getWeather(val)
      this.getHourly(val)
      this.getAirWeather(val)
      this.getYiYanInfo(val)
    }
    callback && callback()
  },
  ...
  init(params, callback) {
    ...
    wx.getLocation({
      success: (res) => {
        ...
        this.getAirWeather(`${res.latitude},${res.longitude}`)
        callback && callback()
      },
      fail: (res) => {
        this.fail(res)
